...
7. Now copy the code of **1 Place the following code where you'd like Disqus to load:** & past on the end of **post_detail_page**

```python
8. blog/post_detail.html
...
```
9. Now Reload your post_detail_page & see It's working
---
