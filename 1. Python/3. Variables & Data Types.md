...
1. **int type variable,**  Integer মানে পূর্ণসংখ্যা। যথা: 1, 2, 100, 501

2. **float type variable,**  float -মানে দশমিক সংখ্যা বা ভগ্নাংশ। 3.1416,
20.87

3. **str type variable,**  এককথায় বলতে গেলে সিঙ্গেল কোট (‘ ’) বা ডাবল কোটের
(“ ”) ভেতরে যা-ই থাকে, তাকেই str বলে।

4. **bool type variable,**  boolean টাইপের ভেরিয়েবলের মান True অথবা False হয়।
